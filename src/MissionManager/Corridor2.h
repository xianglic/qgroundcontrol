...
Q_DECLARE_LOGGING_CATEGORY(Corridor2Log)

class Corridor2 : public TransectStyleComplexItem
{
    Q_OBJECT
...
public:
    ...
    Corridor2(PlanMasterController* masterController, bool flyView, const QString& kmlFile);
    ...
    QString             commandDescription  (void) const final { return tr("Corridor Scan2"); }
    QString             commandName         (void) const final { return tr("Corridor Scan2"); }
    QString             abbreviation        (void) const final { return tr("C2"); }
